...
import { createShortUrl, deleteShortUrl, getUrlInfById, getUserInfo, openUrl } from "../controllers/urlController.js";
...
urlRouter.get('/users/me', validateToken, getUserInfo)
